...
const Editbio = () => {
  ...
  const favourate = biodata.find(bio => bio?._id == id);
    ...
    function handleSubmit(e) {
      ...
      axiosSecure.put(`/biodata/${id}`, updateData)
      .then(res => {
    ...
    //     partnerHeight,
    //     mobile,
    //     gender, // Ensure these are defined
    //     date,
    //     height,
    //     weight,
    //     occupation,
    ...
    //   try {
    //     const res = await axiosSecure.put(`/biodata/${id}`, updateData);
