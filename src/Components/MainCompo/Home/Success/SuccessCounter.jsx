...
const SuccessCounter = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-green-100 via-green-200 to-green-300 rounded-lg shadow-md py-8 px-6 my-10">
      <h2 className="text-4xl font-bold text-center text-green-600 mb-10">Our Website Stats</h2>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-5  py-3 max-w-6xl mx-auto">
        ...
        <div className="flex flex-col items-center bg-white px-2 py-3 rounded-lg shadow-lg hover:scale-105 transition transform duration-300">
          ...
          <h2 className="text-lg md:text-xl font-semibold text-green-600 mb-2">Total Bio Data</h2>
        ...
        <div className="flex flex-col items-center bg-white px-2 py-3 rounded-lg shadow-lg hover:scale-105 transition transform duration-300">
          ...
          <h2 className="text-lg md:text-xl font-semibold text-green-600 mb-2">Total Male Bio Data</h2>
        ...
        <div className="flex flex-col items-center bg-white px-2 py-3 rounded-lg shadow-lg hover:scale-105 transition transform duration-300">
          ...
          <h2 className="text-lg md:text-xl font-semibold text-green-600 mb-2">Total Female Bio Data</h2>
        ...
        <div className="flex flex-col items-center bg-white px-2 py-3 rounded-lg shadow-lg hover:scale-105 transition transform duration-300">
          ...
          <h2 className="text-lg md:text-xl font-semibold text-green-600 mb-2">Marriages Completed</h2>
