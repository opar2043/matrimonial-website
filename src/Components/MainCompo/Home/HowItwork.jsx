  ...
  return (
    <div className="bg-gray-100 py-12 px-6">
        ...
        <div className="flex-1 bg-white p-6 rounded-lg shadow-md">
          ...
          <ul className=" text-gray-800">
            <li className="flex items-start">
              <span className="text-pink-500 font-bold text-lg mr-2">1.</span>
              Register or Log in to your account.
            </li>
            <li className="flex items-start">
              <span className="text-pink-500 font-bold text-lg mr-2">2.</span>
              Search and browse verified profiles.
            </li>
            <li className="flex items-start">
              <span className="text-pink-500 font-bold text-lg mr-2">3.</span>
              Choose a partner that matches your preferences.
            </li>
            <li className="flex items-start">
              <span className="text-pink-500 font-bold text-lg mr-2">4.</span>
              Upgrade to Premium to connect.
            </li>
            <li className="flex items-start">
              <span className="text-pink-500 font-bold text-lg mr-2">5.</span>
              Communicate and discuss your future plans.
            </li>
            <li className="flex items-start">
              <span className="text-pink-500 font-bold text-lg mr-2">6.</span>
      ...
      <div className="bg-white py-12 px-6 mt-16 rounded-lg shadow-md max-w-6xl mx-auto">
        <h3 className="text-3xl font-bold text-center text-pink-500 mb-6">
          Why Choose Us?
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 ">
          {/* Reason 1 */}
          <div className="flex-1 py-5 px-4 rounded-lg bg-orange-500 bg-opacity-15 shadow-sm">
